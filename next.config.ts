...
const cspHeader = `
  ...
  connect-src 'self' https://*.supabase.co https://*.google-analytics.com https://*.analytics.google.com https://www.google.com https://api.stripe.com https://api.cloudinary.com https://*.cloudinary.com https://www.facebook.com https://*.facebook.com https://*.conversionsapigateway.com https://*.run.app;
  frame-src 'self' https://www.google.com https://js.stripe.com https://maps.google.com https://upload-widget.cloudinary.com https://widget.cloudinary.com https://www.facebook.com;
