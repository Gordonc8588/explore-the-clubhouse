...
export const mockChildren: Child[] = [
  // Children for booking-001 (Sarah Thompson's 2 children)
  {
    ...
    emergency_contact_2_name: 'Susan Thompson',
    emergency_contact_2_phone: '07700 900125',
  ...
  // Child for booking-003 (Emma Davies's child)
  {
    ...
    emergency_contact_relationship: 'family_friend',
    emergency_contact_2_name: 'Anna Davies',
    emergency_contact_2_phone: '07700 900791',
