...
const mockAttendanceData: Record<string, Child[]> = {
  "2026-01-20": [
    {
      id: "C001",
      name: "Emma Johnson",
    ...
    },
    {
      ...
      parentPhone: "07700 900127",
      session: "PM",
      allergies: ["Dairy"],
      medicalNotes: "Lactose intolerant - avoid all dairy products",
      emergencyContact: {
        name: "James Williams",
        phone: "07700 900128",
        relationship: "Father",
    ...
    },
    {
      ...
      parentPhone: "07700 900129",
      session: "Full",
      allergies: ["Gluten", "Eggs"],
      medicalNotes: "Coeliac disease",
      emergencyContact: {
        name: "Sophie Brown",
        phone: "07700 900130",
        relationship: "Mother",
    ...
    },
    {
      ...
      parentPhone: "07700 900133",
      session: "Full",
      allergies: [],
      medicalNotes: "Asthma - has inhaler in bag",
      emergencyContact: {
        name: "Sarah Wilson",
        phone: "07700 900134",
        relationship: "Mother",
    ...
    },
    {
      ...
      parentPhone: "07700 900135",
      session: "PM",
      allergies: ["Bee stings"],
      medicalNotes: "Severe bee allergy - carries EpiPen",
      emergencyContact: {
    ...
    },
    {
      id: "C008",
      name: "George Davies",
      parentName: "Andrew Davies",
      parentPhone: "07700 900137",
      session: "AM",
      allergies: [],
      medicalNotes: "",
      emergencyContact: {
...
export default function DailyAttendancePage() {
  ...
  const attendance = mockAttendanceData[selectedDate] || [];
  ...
  // Update URL when date changes (keep in sync)
  useEffect(() => {
