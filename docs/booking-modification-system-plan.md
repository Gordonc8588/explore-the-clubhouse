...
- **Phase 4b — Add days → payment-link upcharge.** The deferred-webhook upgrade path (pending modification → hosted Checkout → webhook applies) + matching emails. _Next._
